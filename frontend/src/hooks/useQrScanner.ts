  ...
  const startCamera = async () => {
    ...
    try {
      ...
      intervalRef.current = window.setInterval(async () => {
        ...
        // Trava novas leituras até essa terminar de processar — sem isso, se
        // onDecode demorar (chamada de rede), o mesmo QR ainda visível na
        // câmera dispara de novo no próximo tick antes da primeira terminar.
