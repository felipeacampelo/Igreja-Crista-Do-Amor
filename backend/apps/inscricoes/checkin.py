...
O QR e o código manual carregam o mesmo Inscricao.token, então a resolução é
idêntica para os dois caminhos — não há necessidade de duas funções.
